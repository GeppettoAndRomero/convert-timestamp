...
const CACHE_NAME = 'convert-timestamp-v1';
const RUNTIME_CACHE = 'convert-timestamp-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/convert-timestamp/',
  '/convert-timestamp/manifest.json',
  '/convert-timestamp/icon-192.png',
  '/convert-timestamp/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/convert-timestamp/manifest.json';
}
